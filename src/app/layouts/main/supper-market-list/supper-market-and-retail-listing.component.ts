...
@Component({
  selector: 'app-supper-market-and-retail-listing',
  templateUrl: './supper-market-and-retail-listing.component.html',
  styleUrls: ['./supper-market-and-retail-listing.component.scss']
})
export class SupperMarketAndRetailListingComponent {
  data: any = {};
  ...
  getDataOfTable() {
    ...
    this.multimediaService.getSuperMarketTable(payload).subscribe((response) => {
