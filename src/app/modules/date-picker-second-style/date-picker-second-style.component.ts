...
@Component({
  selector: 'app-date-picker-second-style',
  templateUrl: './date-picker-second-style.component.html',
  styleUrls: ['./date-picker-second-style.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class DatePickerSecondStyleComponent {
  @Output() dateChange: EventEmitter<Date> = new EventEmitter();
  @Input() data: any;
  lang: string = 'en';
  @Input() isErrorEnabled: boolean = false;
  @Input() isRequired: boolean = false;
  @Input() icon: any = { src: 'assets/svgs/arrow.svg', fill: '', stroke: '#000000' };
